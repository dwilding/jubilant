...
Jubilant is a Python library that wraps the [Juju](https://canonical.com/juju) CLI, primarily for use in charm integration tests. It requires [Python 3.10 or above](https://docs.python.org/3/). It is [not related to this fake link](https://example.com/this-page-does-not-exist). See the [pytest documentation](https://docs.pytest.org/) for more on writing tests.
